...
//Games
export function fetchGames (state) {
  return axiosInstance.get('/games')
}

export function fetchGame (state, id) {
  return axiosInstance.get(`/game/${id}`)
}

export function fetchGamesByUser (state, id) {
  return axiosInstance.get(`/user/${id}/games`)
}

export function updateGame(state, data) {
  return axiosInstance.put(`/game/${data.id}`, data)
}

export function deleteGame(state, id) {
  return axiosInstance.delete(`/game/${id}`, id)
}

export function createGame(state, data) {
  return axiosInstance.post('/game', data)
}

//Gallery

export function uploadGallery(state, data) {
  return axiosInstance.post('game/gallery', data)
}

export function deleteImageGallery(state, id) {
  return axiosInstance.delete(`game/gallery/${id}`, id)
}
